    ...
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      ...
      >
        ...
        <h2 className="mt-20 text-2xl font-bold mb-6 flex items-center gap-2">
          <span className="bg-white text-blue-700 p-2 rounded-full">SUPER-ADMIN</span>
          BNR CLEAN
        </h2>

        {/* ✅ Navigation */}
        <nav className="space-y-4 flex-1">
          <Link href="/super" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-500">
            <FaHome size={20} /> ACCUEIL
          </Link>

          {/* structures*/}
          <Link href="/structures-list" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-500">
            <FaSearch size={20} /> Structures
          </Link>
        
          {/* Abonnements*/}
          <Link href="/abonnements" className="flex items-center gap-3 p-3 rounded-lg hover:bg-blue-500">
            <FaSearch size={20} /> Abonnements
          </Link>
        </nav>
